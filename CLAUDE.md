...
- LLM: default `claude-haiku-4-5-20251001`, escalation `claude-sonnet-5`. Model ids live in `config/llm.yml` — verify current ids at https://docs.claude.com before first use and record the check in DECISIONS.md.
