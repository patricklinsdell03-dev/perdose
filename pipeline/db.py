...
CREATE TABLE IF NOT EXISTS product_actives (
  ...
  amount_basis    TEXT NOT NULL,      -- 'stated_elemental'|'estimated_from_compound'|'stated_total'|'stated_component_sum'|'stated_extract'|'stated_compound'|'stated_constituent'|'per_serving'
